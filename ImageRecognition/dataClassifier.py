...
def readCommand( argv ):
  ...
  if(options.classifier == "mostFrequent"):
    ...
    # initialized mira weights and C 
    ...
    print ("Unknown classifier:", options.classifier_)
    print (USAGE_STRING)
...
def runClassifier(args, options):
  ...
  #x =[45,90,135,135,180,225,270,315,360,405]
  #for val in x:
  #for iter in range(5):
...
#print (str(correct), ("correct out of " + str(len(validationLabels)) + " (%.1f%%).") % (100.0 * correct / len(validationLabels)))
  ...
  #print("Iteration [" + str(iter + 1)+ "] with" +str(val) +" training images")
